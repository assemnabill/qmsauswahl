...
\section{Einleitung}
Die Auswahl eines wirksamen QMS ist eine nicht triviale Herausforderung, die einen besonderen Ansatz erfordert. Heute übersteigt die Zahl der zertifizierten QMS 1,5 Millionen \cite{Leontyuk_2019}. Diese Größenordnung an Optionen, die über eine Handvoll hinausgeht, kann zur Paralyse und schlechter Wahl führen und die Zufriedenheit mit dem ausgewählten System verringern \cite{oulasvirta2009when}.
\\
\\
